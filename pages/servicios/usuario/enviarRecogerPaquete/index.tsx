          ...
          <div className="flex items-center justify-center m-0 p-0">
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg">
              <div className='mt-24 px-6 m-0 p-0'>
                <h1 className="text-2xl font-semibold text-center text-gray-500 mt-4 mb-6">Enviar o recoger paqute</h1>
                <form>
                  <div className="mb-4">
                    <label className="block mb-2 text-sm text-gray-600">¿Dónde recogemos el paquete?</label>
                  ...
                  <div className="mb-4">
                    <label className="block mb-2 text-sm text-gray-600">¿Dónde entregamos el paquete?</label>
                  ...
                  <div className="mb-4">
                    <label className="block mb-2 text-sm text-gray-600">Dimensiones del paquete</label>
                    <input type="text" id="size" placeholder='largo x ancho x alto' className="w-full bg-transparent ring-2 ring-gray-300 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" 
                      required
                      {...register("size", {required: true})}
                    />
                    {(errors.size?.type === 'required') && <p className="text-red-500">Dees indicar las dimensiones del paqute</p>}
                  </div>
                  <div className="mb-4">
                    <label className="block mb-2 text-sm text-gray-600">Peso del paquete</label>
                    <input type="weight" id="peso" className="w-full bg-transparent ring-2 ring-gray-300 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" 
                      required
                      {...register("weight", {required: true})}
                    />
                    {(errors.weight?.type === 'required') && <p className="text-red-500">Dees indicar el peso del paqute</p>}
                  </div>
                  <div className="mb-6">
                    <label className="block mb-2 text-sm text-gray-600">Hora de recogida</label>
                    ...
                    />
                    {(errors.time?.type === 'required') && <p className="text-red-500">Selecciona la hora en la que debemos recoger el paquete</p>}
                  </div>
                  <div className="w-full mb-6 inline-flex items-center">
                    <input type="checkbox" id="food" className="form-checkbox w-16" 
