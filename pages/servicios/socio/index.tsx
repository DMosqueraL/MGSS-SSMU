                ...
                <div className="mt-20 flex items-center justify-center m-0 p-0">
                    ...
                    <div className="max-w-md w-full bg-white rounded-lg">
                        <div className='px-6 m-0 p-0'>
                            <button onClick={aceptarServicio} type="submit" className="my-8 mb-8 w-full rounded-2xl border-b-4 border-b-blue-600 bg-blue-500 py-2 font-bold text-white hover:bg-blue-400 active:translate-y-[0.125rem] active:bord    er-b-blue-400">Estoy disponible</button>              
                        </div>
                    </div>
                </div>
            </div>
